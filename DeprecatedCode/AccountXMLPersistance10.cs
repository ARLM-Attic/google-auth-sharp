...
namespace GoogleAuthClone.Deprecated
{
    ...
    public class AccountXMLPersistance10
    {
        ...
        static public bool CheckForLegacyAccounts(out bool fileExists, out Exception exceptionArg)
        {
            ...
            try
            {
                string theAssembly = Assembly.GetAssembly(typeof(AccountXMLPersistance10)).CodeBase;
        ...
        static public bool PutEncryptedAccounts(string fileName, Dictionary<string, TOTPAccount> theAccounts, AccountPassPhrase10 appStore, bool overwrite, out Exception exceptionArg)
        {
        ...
        static public Dictionary<string, TOTPAccount> GetEncryptedAccounts(string filename, AccountPassPhrase10 appStore, out bool foundData, out bool wasAbleToDecryptData, out Exception exceptionArg)
        {
            exceptionArg = null;
